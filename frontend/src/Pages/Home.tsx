                    ...
                    <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                      ...
                      >
                        <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg p-6">
                          ...
                          <h5 className="mt-4 font-bold">Types of Keto Diet</h5>
                          ...
                          <div className="bg-gray-200 p-6">
                            <p>
                              A diet with no more than 50g of carbohydrates per
                              day.
                            </p>
                          </div>
                          ...
                          <div className="bg-gray-200 p-6">
                            <p>
                              ...
                              Instead, it uses MCT oil in food, namely, coconut
                              oil for the production of ketone bodies.
                            </p>
                          </div>
                          ...
                          <div className="bg-gray-200 p-6">
                            <p>
                              In this, adding of carbohydrates is allowed around
                              the workout hours.
                            </p>
                          </div>
                          ...
                          <div className="bg-gray-200 p-6">
                            <p>
                              ...
                              diet requires to be handled with close supervision
                              and care because you may need timely check-ups of
                              your blood parameters since it involves high fat,
                              minimal protein and very low carb intake.
                            </p>
                          </div>
                          <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                            <button
                              type="button"
                              className="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-bold  font-bold text-gray-900 shadow-lg ring-1 ring-inset ring-gray-300 hover:bg-gray-300 sm:mt-0 sm:w-auto"
                        ...
                        <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg p-6">
                          ...
                          <div className="bg-gray-200 p-6 t-2">
                            <p>
                              ...
                              health. It can help reduce stress and anxiety and
                          ...
                          <div className="bg-gray-200 p-6">
                            <p>
                              ...
                              can lead to increased stress and anxiety, and can
                              also affect mood and cognitive function.
                            </p>
                          </div>
                          <div className="bg-gray-200 p-6">
                            <p>
                              4. Connect with Others: Social connection is
                              important for mental health. Make time to connect
                              with friends and family, or join a community group
                              or club to meet new people.
                            </p>
                          </div>
                          <div className="bg-gray-200 p-6">
                            <p>
                              5. Practice Self-Care: Taking care of yourself is
                              essential for good mental health. This can include
                              activities like taking a relaxing bath, reading a
                              book, or going for a walk.
                            </p>
                          </div>
                          <div className="p-6">
                            <p>
                              By incorporating these simple practices into your
                              daily routine, you can help improve your mental
